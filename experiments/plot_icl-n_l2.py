...
exclude_prefix = None
exclude_suffix = None
include_evals = ["{}_l2".format(n_closest) for n_closest in [2, 10, 20, 40, 100, 500]]
...
map_eval_to_title = {
    ...
    "cos_abstract_hierarchy": "Cosine Similarity",
}
for n_closest in [2, 10, 20, 40, 100, 500]:
    map_eval_to_title["{}_l2".format(n_closest)] = "{} Closest in L2".format(n_closest)
...
def plot_main_plot():
    save_path = os.path.join(plot_path, "{}-n_l2.pdf".format(ablation_name))
