...
class ParameterizedAcrobotEnv(Env):
    """
    ## Description
    ...
    def __init__(
        ...
        **kwargs,
        ...
        if use_default:
            ...
            self.LINK_LENGTH_1 = sample_data(0.9, 1.1, self._rng)  # [m]
            self.LINK_LENGTH_2 = sample_data(0.9, 1.1, self._rng)  # [m]
            self.LINK_MASS_1 = sample_data(0.9, 1.1, self._rng)  #: [kg] mass of link 1
            self.LINK_MASS_2 = sample_data(0.9, 1.1, self._rng)  #: [kg] mass of link 2
            self.LINK_COM_POS_1 = sample_data(
                0.45, 0.55, self._rng
            )  #: [m] position of the center of mass of link 1
            self.LINK_COM_POS_2 = sample_data(
                0.45, 0.55, self._rng
            )  #: [m] position of the center of mass of link 2
            self.LINK_MOI = 1.0  #: moments of inertia for both links
            self.GRAVITY = sample_data(9.0, 11.0, self._rng)
            self.modified_attributes = {
                "link_length_1": self.LINK_LENGTH_1,
                "link_length_2": self.LINK_LENGTH_2,
                "link_mass_1": self.LINK_MASS_1,
                "link_mass_2": self.LINK_MASS_2,
                "link_com_pos_1": self.LINK_COM_POS_1,
                "link_com_pos_2": self.LINK_COM_POS_2,
                "link_moi": self.LINK_MOI,
