...
mtbc_pretrain_dir = "/home/bryanpu1/projects/jaxl/scripts/mtil/local/rebuttal/metaworld/results/mtbc_pretrain/{}".format(arch_name)
config_out_path = "/home/bryanpu1/projects/jaxl/scripts/mtil/local/rebuttal/metaworld/configs/finetune_mtbc-{}".format(arch_name)
...
for task_i, num_tasks in enumerate(pretrained_configs):
    ...
    for eval_seed in eval_seeds:
        ...
        expert_dataset = os.path.join(expert_datasets_dir, "test_metaworld-seed_{}.gzip".format(eval_seed))
