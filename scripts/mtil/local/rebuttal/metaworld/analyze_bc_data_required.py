...
runs_dir = "/home/bryanpu1/projects/jaxl/scripts/mtil/local/rebuttal/metaworld/results/bc/{}/{}".format(
    expert_data, arch_name
)
...
script_out_path = "/home/bryanpu1/projects/jaxl/scripts/mtil/local/rebuttal/metaworld/evaluate-{}.sh".format(
    arch_name
)
    ...
    for run_i, run_dir in enumerate(runs_per_num_data):
        ...
        sh_content += "python {} --run_path={} --env_seed={} --run_seed={} --scrambling_step={} --num_episodes={} --save_stats={} --img_res={} --device={}{}\n".format(
            ...
            os.path.join(
                ...
                expert_data,
                runs_dir.split("/")[-1],
                "{}-{}".format(run_dir.split("-")[0], run_dir.split("-")[1]),
                "result.pkl",
            ),
            img_res,
            device,
