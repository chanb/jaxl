...
python ../../../sweep_finetune_mtbc.py \
    ...
    --num_samples=1250 \
    --exp_name=cheetah-main-quarter_more_target_data
...
chmod +x run_all-*.sh
sbatch run_all-finetune-mtbc-single_sweep-cheetah-main-quarter_more_target_data_continuous.sh
sbatch run_all-finetune-mtbc-single_sweep-cheetah-main-quarter_more_target_data_discrete.sh
