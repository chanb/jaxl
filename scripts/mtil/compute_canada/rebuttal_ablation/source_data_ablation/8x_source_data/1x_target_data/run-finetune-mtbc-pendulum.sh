...
python ../../../../sweep_finetune_mtbc.py \
    ...
    --num_samples=2000 \
    --exp_name=pendulum-8x_source_data-1x_target_data
...
chmod +x run_all-*.sh
sbatch run_all-finetune-mtbc-single_sweep-pendulum-8x_source_data-1x_target_data_continuous.sh
sbatch run_all-finetune-mtbc-single_sweep-pendulum-8x_source_data-1x_target_data_discrete.sh
