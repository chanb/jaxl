...
chmod +x run_all-*.sh
sbatch run_all-finetune-mtbc-single_sweep-pendulum-8x_source_data-2x_target_data_continuous.sh
sbatch run_all-finetune-mtbc-single_sweep-pendulum-8x_source_data-2x_target_data_discrete.sh
