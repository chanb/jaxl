...
python ../../../sweep_finetune_mtbc.py \
    ...
    --out_dir=${HOME}/scratch/data/finetune_mtbc_main-main-half_more_target_data \
    --run_seed=0 \
    --num_runs=1 \
    ...
    --num_samples=1500 \
    --exp_name=pendulum-main-half_more_target_data
...
chmod +x run_all-*.sh
sbatch run_all-finetune-mtbc-single_sweep-pendulum-main-half_more_target_data_continuous.sh
sbatch run_all-finetune-mtbc-single_sweep-pendulum-main-half_more_target_data_discrete.sh
