...
python ../../../sweep_finetune_mtbc.py \
    ...
    --num_heldouts=10 \
    --num_samples=3000 \
    --exp_name=walker-main-half_more_target_data \
    --run_time=00:30:00
...
chmod +x run_all-*.sh
sbatch run_all-finetune-mtbc-single_sweep-walker-main-half_more_target_data_continuous.sh
sbatch run_all-finetune-mtbc-single_sweep-walker-main-half_more_target_data_discrete.sh
