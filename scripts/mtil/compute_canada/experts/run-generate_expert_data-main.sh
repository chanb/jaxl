...
python ../generate_expert_data.py \
    ...
    --runs_dir=${HOME}/scratch/data/experts/cartpole/continuous/runs \
    --exp_name=cartpole_cont
...
python ../generate_expert_data.py \
    ...
    --runs_dir=${HOME}/scratch/data/experts/frozenlake/discrete/runs \
    --exp_name=frozenlake_disc
...
chmod +x run_all-*.sh
sbatch run_all-generate_expert_data-cartpole_cont.sh
sbatch run_all-generate_expert_data-frozenlake_disc.sh
