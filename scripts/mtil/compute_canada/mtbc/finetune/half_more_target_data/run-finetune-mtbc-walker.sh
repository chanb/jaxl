...
chmod +x run_all-*.sh
sbatch run_all-finetune-mtbc-single_sweep-walker-half_more_target_data_continuous.sh
sbatch run_all-finetune-mtbc-single_sweep-walker-half_more_target_data_discrete.sh
