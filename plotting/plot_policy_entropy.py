        ...
        for agent_path, _, filenames in os.walk(variant_path):
            for filename in filenames:
                ...
                for checkpoint_name in os.listdir(auxes):
                    ...
                    entropies[checkpoint_i].append(np.mean(data[CONST_POLICY][CONST_ENTROPY]))
...
fig.tight_layout()
fig.savefig(f'{save_path}/policy_entropies.pdf', format='pdf', bbox_inches='tight', dpi=600)
